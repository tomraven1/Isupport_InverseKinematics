...
%              end
%             if Counter<100
%                                     target(1,Counter)=150;
%                    target(2,Counter)=150;
%                   target(3,Counter)=-370;
%                   targeto(1,Counter)=0.3;
%             else
%                                     target(1,1:pdis)=150;
%                    target(2,Counter)=-100;
%                   target(3,Counter)=-350;
%                   targeto(1,Counter)=0.3;
%             end
      ...
      %  target(:,Counter)=posi(:,pk);
        ...
        %targeto(:,Counter)=0;
        %targeto(:,Counter)=[0*(0.5+sin(Counter/10)/2),sin(Counter/20)];
       ...
       %comp=net([inim([1:8],Counter);ini([1:6],Counter);target([1,3],Counter);posnow(Counter,[1,3])';targeto(1,Counter);orivec(3,Counter)]);
        ...
        inim([1:8],Counter+1)=comp(1:8);
        ini([1:6],Counter+1)=comp(9:end);
